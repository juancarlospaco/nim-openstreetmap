...
import asyncdispatch, httpclient, strformat, strutils, xmlparser, xmltree, uri, httpcore, base64
...
proc osm_http_request(this: OSM | AsyncOSM, endpoint: string, http_method: HttpMethod, body = ""): Future[XmlNode] {.multisync.} =
...
proc get_bounding_box*(this: OSM | AsyncOSM, left, bottom, right, top: float): Future[XmlNode] {.multisync.} =
...
proc put_changeset_create*(this: OSM | AsyncOSM, payload: XmlNode): Future[XmlNode] {.multisync.} =
...
proc get_changeset*(this: OSM | AsyncOSM, id: int, include_discussion = true): Future[XmlNode] {.multisync.} =
...
proc put_changeset*(this: OSM | AsyncOSM, id: int, payload: XmlNode): Future[XmlNode] {.multisync.} =
...
proc put_changeset_close*(this: OSM | AsyncOSM, id: int): Future[XmlNode] {.multisync.} =
...
proc get_changeset_download*(this: OSM | AsyncOSM, id: int): Future[XmlNode] {.multisync.} =
...
proc post_changeset_expand_bbox*(this: OSM | AsyncOSM, id: int, payload: XmlNode): Future[XmlNode] {.multisync.} =
...
proc get_changesets_bbox*(this: OSM | AsyncOSM, left, bottom, right, top: float): Future[XmlNode] {.multisync.} =
...
proc get_changesets_user*(this: OSM | AsyncOSM, user: string): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Query:_GET_.2Fapi.2F0.6.2Fchangesets
  result = await osm_http_request(this, endpoint=fmt"changesets?user={user}", http_method=HttpGet)

proc get_changesets_display_name*(this: OSM | AsyncOSM, display_name: string): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Query:_GET_.2Fapi.2F0.6.2Fchangesets
  result = await osm_http_request(this, endpoint=fmt"changesets?display_name={display_name}", http_method=HttpGet)

proc get_changesets_time*(this: OSM | AsyncOSM, time1, time2: string): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Query:_GET_.2Fapi.2F0.6.2Fchangesets
...
proc get_changesets_open*(this: OSM | AsyncOSM, open: bool): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Query:_GET_.2Fapi.2F0.6.2Fchangesets
  let a = if open: "open=true" else: "closed=true"
  result = await osm_http_request(this, endpoint=fmt"changesets?{a}", http_method=HttpGet)

proc get_changesets_cid*(this: OSM | AsyncOSM, cid: seq[int]): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Query:_GET_.2Fapi.2F0.6.2Fchangesets
  let a = cid.join(",")
  result = await osm_http_request(this, endpoint=fmt"changesets?{a}", http_method=HttpGet)

proc post_changeset_upload*(this: OSM | AsyncOSM, id: int, payload: XmlNode): Future[XmlNode] {.multisync.} =
...
proc post_changeset_comment*(this: OSM | AsyncOSM, id: int, comment: string): Future[XmlNode] {.multisync.} =
...
proc post_changeset_subscribe*(this: OSM | AsyncOSM, id: int): Future[XmlNode] {.multisync.} =
...
proc post_changeset_unsubscribe*(this: OSM | AsyncOSM, id: int): Future[XmlNode] {.multisync.} =
...
proc put_nodewayrelation_create*(this: OSM | AsyncOSM, element: string, payload: XmlNode): Future[XmlNode] {.multisync.} =
...
proc get_nodewayrelation*(this: OSM | AsyncOSM, element: string, id: int): Future[XmlNode] {.multisync.} =
...
proc put_nodewayrelation_update*(this: OSM | AsyncOSM, element: string, id: int, payload: XmlNode): Future[XmlNode] {.multisync.} =
...
proc delete_nodewayrelation*(this: OSM | AsyncOSM, element: string, id: int): Future[XmlNode] {.multisync.} =
...
proc get_nodewayrelation_history*(this: OSM | AsyncOSM, element: string, id: int): Future[XmlNode] {.multisync.} =
...
proc get_nodewayrelation_version*(this: OSM | AsyncOSM, element: string, id: int, version: int): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
  assert element in ["node", "way", "relation"], err_msg_ele
  result = await osm_http_request(this, endpoint=fmt"{element}/{id}/{version}", http_method=HttpGet)

proc get_nodewayrelation_parameters*(this: OSM | AsyncOSM, element: string, id: int, parameters: seq[int]): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
  assert element in ["node", "way", "relation"], err_msg_ele
  let a = parameters.join(",")
  result = await osm_http_request(this, endpoint=fmt"{element}s?{element}s={a}", http_method=HttpGet)

proc get_nodewayrelation_relations*(this: OSM | AsyncOSM, element: string, id: int): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
  assert element in ["node", "way", "relation"], err_msg_ele
  result = await osm_http_request(this, endpoint=fmt"{element}/{id}/relations", http_method=HttpGet)

proc get_node_ways*(this: OSM | AsyncOSM, id: int): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
  result = await osm_http_request(this, endpoint=fmt"node/{id}/ways", http_method=HttpGet)

proc get_wayrelation_full*(this: OSM | AsyncOSM, element: string, id: int): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
...
proc get_trackpoints*(this: OSM | AsyncOSM, left, bottom, right, top: float, pageNumber: int8): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
...
proc get_gpx_details*(this: OSM | AsyncOSM, id: int): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
  result = await osm_http_request(this, endpoint=fmt"gpx/{id}/details", http_method=HttpGet)

proc get_gpx_data*(this: OSM | AsyncOSM, id: int): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
...
proc get_users*(this: OSM | AsyncOSM, users: seq[int]): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
  let a = users.join(",")
...
proc put_user_preferences*(this: OSM | AsyncOSM, your_key, value: string): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
...
proc get_notes*(this: OSM | AsyncOSM, left, bottom, right, top: float, limit: range[1..10000] = 100, closed: int8 = 7): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
...
proc post_notes*(this: OSM | AsyncOSM, lat, lon: float, text: string): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Unsubscribe:_POST_.2Fapi.2F0.6.2Fchangeset.2F.23id.2Funsubscribe
...
proc post_notes_comment*(this: OSM | AsyncOSM, id: int, text: string): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Unsubscribe:_POST_.2Fapi.2F0.6.2Fchangeset.2F.23id.2Funsubscribe
  assert len(text) < max_str_len, err_msg_len
  result = await osm_http_request(this, endpoint=fmt"notes/{id}/comment?text={encodeUrl(text.strip)}", http_method=HttpPost)

proc post_notes_close*(this: OSM | AsyncOSM, id: int, text: string): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Unsubscribe:_POST_.2Fapi.2F0.6.2Fchangeset.2F.23id.2Funsubscribe
  assert len(text) < max_str_len, err_msg_len
  result = await osm_http_request(this, endpoint=fmt"notes/{id}/comment?text={encodeUrl(text.strip)}", http_method=HttpPost)

proc post_notes_reopen*(this: OSM | AsyncOSM, id: int, text: string): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Unsubscribe:_POST_.2Fapi.2F0.6.2Fchangeset.2F.23id.2Funsubscribe
  assert len(text) < max_str_len, err_msg_len
  result = await osm_http_request(this, endpoint=fmt"notes/{id}/comment?text={encodeUrl(text.strip)}", http_method=HttpPost)

proc get_notes_search*(this: OSM | AsyncOSM, q: string, limit: range[1..10000] = 100, closed: int8 = 7): Future[XmlNode] {.multisync.} =
  ## https://wiki.openstreetmap.org/wiki/API_v0.6#Read:_GET_.2Fapi.2F0.6.2F.5Bnode.7Cway.7Crelation.5D.2F.23id
